# Team_Manager
An enterprise-grade Employee Management &amp; Workforce Analytics platform built with Flutter. Features real-time CRUD directory operations, departmental performance heatmaps, financial resource allocation tracking, and AI-driven talent forecasting.
...
Key Features
Intelligent Directory Management: Seamlessly add, view, update, and remove employee records. The system provides real-time visibility into headcount and salary benchmarks.
...
Financial Resource Allocation: Interactive pie charts detailing payroll distribution across the entire organization.

AI-Powered Forecasting: The app includes a "Generative AI" insights engine that analyzes attendance, quality, and productivity metrics to provide automated talent classification (e.g., "Rising Talent") and actionable HR recommendations.

Advanced Data Visualization: Leveraging the power of the fl_chart library to provide professional, readable graphs on staffing trends, tech stack frequency, and departmental budgets.
